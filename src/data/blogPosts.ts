...
export const blogPosts: BlogPost[] = [
  ...
  {
    id: '8',
  title: 'The Modular Advantage: How IntraSphere Achieves Fastest Time-to-Prototype',
  ...
  metaDescription: 'Discover how IntraSphere\' modular technology approach achieves industry-leading prototyping speed while ensuring quality and scalability.',
    content: [
      {
        type: 'paragraph',
  content: 'In connected product development, speed often determines market success. Traditional approaches require building everything from scratch, leading to extended development cycles and increased risk. IntraSphere has pioneered a modular technology approach that achieves the fastest time-to-prototype in the industry while maintaining the quality and reliability needed for commercial success.'
      },
      {
        type: 'heading',
