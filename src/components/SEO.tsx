...
const SEO: React.FC<SEOProps> = ({
  title = 'IntraSphere',
  description = 'IntraSphere Technologies: Pioneering smart engineering solutions with textile sensors for sports, safety, and performance monitoring.',
  type = 'website',
  name = 'IntraSphere Technologies',
  ...
  const blogPostStructuredData = isBlogPost && publishDate ? {
    ...
    author: {
      '@type': 'Organization',
  name: author || 'IntraSphere Technologies',
      url: 'https://wrlds.com'
    },
    publisher: {
      '@type': 'Organization',
  ...
  <meta property="og:site_name" content="IntraSphere Technologies" />
