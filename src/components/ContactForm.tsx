  ...
  const onSubmit = async (data: FormValues) => {
    ...
    try {
      ...
      const templateParams = {
        ...
        to_name: 'IntraSphere Team', // Adding recipient name parameter
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-gray-700 text-lg max-w-2xl mx-auto">
            Have questions ?  Reach out to our team and let's discuss how we can help bring your ideas to life.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8">
            <div className="bg-white p-6 rounded-lg shadow-md border border-gray-700 text-black">
              ...
              <a href="mailto:info@wrlds.com" className="text-blue-500 hover:underline">teamintrasphere@gmail.com</a>
