          ...
          <div className="container mx-auto">
            <div className="max-w-6xl mx-auto">
              ...
              <div className="prose prose-lg max-w-none">
                ...
                >
                  We're always looking for passionate developers and designers to join our growing team. Start your career journey with us!
                </motion.p>
                  ...
                  <div className="bg-white rounded-xl border border-gray-200 p-8 shadow-sm mt-12">
                    ...
                    <div className="bg-white rounded-xl p-6 border border-gray-200">
                      <div className="flex flex-col items-center text-center">
                        ...
                        />
                        <h3 className="text-xl font-bold text-gray-900">Jahnavi Reddy</h3>
