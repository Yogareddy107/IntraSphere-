...
const processes = [
  {
    ...
    description:
      "We begin by understanding your business goals, target audience, and product vision. This ensures every feature aligns with your objectives and delivers measurable results.",
    steps: [
      "Requirement gathering and goal alignment",
  ...
  },
  {
    ...
    title: "UI/UX Design",
    description:
      "Our design team creates stunning, user-centered interfaces that ensure every interaction feels natural, meaningful, and aligned with your brand.",
    steps: [
      "Wireframing and design prototyping",
      "User journey mapping",
      "Visual identity and style guide creation",
  ...
  },
  {
    ...
    description:
      "We turn designs into functional, scalable, and high-performance applications using modern frameworks and best coding practices.",
    steps: [
  ...
  },
  {
    ...
    description:
      "Every product undergoes thorough testing to ensure smooth performance, security, and reliability across all devices and platforms.",
    steps: [
  ...
  },
  {
    ...
    description:
      "We handle seamless deployment and provide continuous monitoring, updates, and technical support to ensure long-term success.",
    steps: [
      "Cloud deployment and version release",
      "App Store / Play Store submission (if applicable)",
